...
test('landing and terminal are separate product surfaces',async()=>{
 ...
 try{
  ...
  assert.match(landing,/<link rel="icon" href="\/favicon\.ico\?v=1" sizes="any">/);
  assert.match(landing,/<link rel="apple-touch-icon" href="\/assets\/meerkat-icon\.png\?v=1">/);
  ...
  assert.match(terminal,/<link rel="icon" href="\/favicon\.ico\?v=1" sizes="any">/);
  assert.match(terminal,/<link rel="apple-touch-icon" href="\/assets\/meerkat-icon\.png\?v=1">/);
