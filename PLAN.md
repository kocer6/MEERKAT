METADATA-FAST verified (2026-09-16): deployed 714228a. 211 VPS tests pass; typecheck/build pass. Five services active, lag zero, metadata queue zero, worker errors null. Public Fresh SSE showed four new tokens acquiring names after 2.98 seconds without reload. Metadata cycles 179-2374 ms after incremental feed writes; collection 2162 ms; enrich 6696 ms. Evidence: docs/evidence/radar-metadata-latency-2026-09-16.md. Score backlog and external price availability remain separate from metadata latency. Next: no required metadata-speed work remains.
