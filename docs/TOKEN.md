...
- The base local evidence terminal remains useful without holding a token.
- The project will not request a seed phrase or private key to unlock analysis.
- Token utility will be described only when implemented and testable.
